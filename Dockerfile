...
RUN pip3 install Babel==2.9.1 chardet==4.0.0 cryptography==3.4.8 decorator==4.4.2 docutils==0.17 ebaysdk==2.1.5 freezegun==1.1.0 geoip2==2.9.0 gevent==22.10.2 greenlet==2.0.2 idna==2.10 Jinja2==3.0.3 \
    ...
    user_agents prestapyt cerberus sqlparse openpyxl pandas html2text pdfminer
